...
This repo is the public record of the service: what is sold, what is not claimed, how to photograph a palm, and the report template the desk actually writes from.
...
Palmistry is folklore. It is not a science. It does not predict the future. A report from this desk is a literary reading of creases in skin, written as craft, not as fact.

The length of a life line is not a lifespan. This desk does not read death, disease, fertility, court results, lottery numbers, or investment returns.
...
Palm photographs and the customer email are used only to write and send that reading. They are not published. They are not sold. They are not used to train models. They are kept only as long as needed to complete the report, then discarded.
